    ...
    return (
        <div className="container pt-32 sm:pt-48 lg:pt-56">
            <div className="text-center">
                ...
                <h1 className="h-14 animate-text text-balance bg-gradient-to-r from-teal-500 via-yellow-500 to-orange-500 bg-clip-text text-5xl font-semibold tracking-tight text-transparent md:h-[5.5rem] md:text-7xl">
                    {appName}
                </h1>
